== lists2 branch
This is a pretty much aborted attempt to rebase my lists addition to some of the latest changes to Openlibrary. It has moved on too much. The last working version of Lists on the very old code is on my lists1 branch. I'm going to attempt to re-add Lists API functionality to the latest, much better, structure on a new, different, branch. I will delete this branch when I'm done.
